                           ...
                           list.colorscheme, list.scales)
{
  ...
  spplot(spdf.ll, zcol = data.name, col = NA, 
         ...
         #               x = list(at = c(-130, -125, -120), 
         #                        labels = parse(text = paste0(c(130, 125, 120), "*degree*W"))),
         #               y = list(at = c(30, 35, 40, 45, 50), 
         #                        labels = parse(text = paste0(c(30, 35, 40, 45, 50), "*degree*N"))))
  )
