...
x <- st_read("C:/Users/sam.woodman/Downloads/eSDM_shpExport/eSDM_Sample_predictions_2_csv__pred__orig.shp", agr = "constant")
# sample_predictions_1
y <- st_read("C:/Users/sam.woodman/Downloads/eSDM_shpExport (1)/eSDM_Sample_predictions_1_csv__PredModel1__orig.shp", agr = "constant")
# sample_predictions_4
z <- st_transform(
  st_read("C:/Users/sam.woodman/Downloads/eSDM_shpExport (2)/eSDM_Sample_predictions_4_gdb__Pred1__orig.shp", agr = "constant"),
  4326
)
