...
orig1.auc <- eSDM::evaluation_metrics(orig1, valid.data, "Pred", "sight")[1]
orig2.auc <- eSDM::evaluation_metrics(orig2, valid.data, "Pred", "sight")[1]
orig3.auc <- eSDM::evaluation_metrics(orig3, valid.data.proj, "Pred", "sight")[1]
...
orig1.clip.auc <- eSDM::evaluation_metrics(orig1.clip, valid.data, "Pred", "sight")[1]
orig2.clip.auc <- eSDM::evaluation_metrics(orig2.clip, valid.data, "Pred", "sight")[1]
orig3.clip.auc <- eSDM::evaluation_metrics(orig3.clip, valid.data.proj, "Pred", "sight")[1]
...
write.csv(df, file = "../eSDM paper/Figures/Table3.csv", row.names = FALSE)
