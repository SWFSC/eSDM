...
gshhg.f.L1 <- st_read("data-raw/GSHHG_shp/f/GSHHS_f_L1.shp")
gshhg.f.L1 <- st_read("data-raw/GSHHG_shp/f/GSHHS_f_L1.shp")
gshhg.h.L1 <- st_read("data-raw/GSHHG_shp/h/GSHHS_h_L1.shp")
gshhg.i.L1 <- st_read("data-raw/GSHHG_shp/i/GSHHS_i_L1.shp")
gshhg.l.L1 <- st_read("data-raw/GSHHG_shp/l/GSHHS_l_L1.shp")
gshhg.c.L1 <- st_read("data-raw/GSHHG_shp/c/GSHHS_c_L1.shp")

gshhg.f.L6 <- st_read("data-raw/GSHHG_shp/f/GSHHS_f_L6.shp")
gshhg.h.L6 <- st_read("data-raw/GSHHG_shp/h/GSHHS_h_L6.shp")
gshhg.i.L6 <- st_read("data-raw/GSHHG_shp/i/GSHHS_i_L6.shp")
gshhg.l.L6 <- st_read("data-raw/GSHHG_shp/l/GSHHS_l_L6.shp")
gshhg.c.L6 <- st_read("data-raw/GSHHG_shp/c/GSHHS_c_L6.shp")
