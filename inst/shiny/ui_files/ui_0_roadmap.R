        ...
        fluidRow(
          box(
            ...
            tags$h5(tags$strong("2) Overlay predictions:"),
                    ...
                    "You can specify load a study area polygon to which to clip the base geometry and/or",
                    "load an erasing polygon to erase area from the base geometry",
            ...
            tags$h5(tags$strong("3) Create ensemble predictions:"),
                    "After creating the overlaid predictions, you can create rescale the overlaid predictions and",
                    "create ensemble predications via a weighted or unweighted average in the 'Create Ensemble Predictions' tab."),
            tags$h5(tags$strong("4) Calculate metrics, generate maps, and export predictions:"),
            ...
            tags$h5(tags$strong("Running the GUI locally:"),
                    "R Shiny applications such as the GUI can be hosted online so that users do not have to run them through R themselves.",
                    "However, running the R Shiny apps locally can be faster than running from them from a server.",
                    "Thus, you can install", tags$em("eSDM"), "from ", #TODO CRAN
                    tags$a("https://github.com/smwoodman/eSDM"), "and follow the instructions to run the GUI locally.",
