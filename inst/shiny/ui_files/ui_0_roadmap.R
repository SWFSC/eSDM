        ...
        fluidRow(
          box(
            ...
            tags$h5(tags$strong("Overview:"),
                    ...
                    "that includes this graphical user interface (GUI), which ensures that the tool is accessible to non-R users.",
            ...
            tags$h5(tags$strong("1) Import SDM predictions or load workspace:"),
                    "You must first either import SDM predictions in the 'Import Predictions' tab,",
