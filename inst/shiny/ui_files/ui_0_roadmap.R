        ...
        fluidRow(
          box(
            ...
            fluidRow(
              ...
              box(
                width = 6,
                tags$strong("Save GUI workspace"),
                textInput("save_app_envir_name", tags$h5("Filename for saved GUI workspace"),
      ...
      column(
        ...
        fluidRow(
          box(
            ...
            #         "with a web-based interface that allows users to import spatial density model (SDM) predictions",
            #         "and create and explore ensemble predictions to inform management",
            ...
            #         "that you can use in the eSDM by clicking the", tags$em("Download sample data"), "button below.",
            ...
            #         "Next, you can overlay your loaded SDM predictions onto a chosen base grid in the 'Overlay Model Predictions' tab.",
            #         "You can specify a study area by loading a study area polygon and/or load a land polygon to crop land area from",
            #         "the predictions if you are working with predictions for a marine environment.",
            #         "After creating the overlaid predictions, you can move on and create ensemble predications in the",
            ...
            #         "Thus, you can download the eSDM code from GitHub at",
            #         tags$a("https://github.com/smwoodman/eSDM", href = "https://github.com/smwoodman/eSDM"),
            #         "and run the eSDM locally. See the GitHub page and the 'Run the eSDM locally' section of the manual for",
