...
#' \link{eSDM_GUI}
#'
#' @details eSDM allows users to overlay SDM predictions onto a single base
...
#'
#' @importFrom dplyr all_of arrange between bind_rows filter group_by left_join
...
#' @importFrom sf st_agr st_set_agr st_area st_bbox st_crop st_crs st_geometry
#'   st_intersection st_intersects st_polygon st_set_geometry st_sf st_sfc
